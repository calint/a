...
public class store_in_ram implements store{
	final private ConcurrentHashMap<Class<? extends itm>,ConcurrentHashMap<String,byte[]>>items=new ConcurrentHashMap<Class<? extends itm>,ConcurrentHashMap<String,byte[]>>();
//	public store_in_ram(){}
