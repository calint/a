...
//		x.el("text-align:left;border:1px solid red;display:inline-table");
		x.pl("pc ir");
		x.pl("|_______|___|__|______|______|  ");
		x.pl("|z n x r|c i|zz|yyyyyy|xxxxxx|  ");
		x.pl("|_______|___|__|______|______|  ");
		x.pl("\\1 2 4 8\\. .\\..\\......\\......\\ ");
		x.pl(" \\    n  \\.  \\..\\......\\......\\ ");
		x.pl("  \\z n x r\\c i\\zz\\yyyyyy\\xxxxxx\\");
...
//		x.elend();
		...
		x.pl(":  shf : "+fld("zy00",Integer.toHexString(opshf))+" : r[y]>>=z             :");
		x.pl(":  shf : "+fld("zy00",Integer.toHexString(opshf))+" : r[y]<<=z             :");
...
//		x.pl(":  skp : "+fld("im00",Integer.toHexString(opskp))+" : pc+=imm8             :");
		...
		x.pl(":------:------:----------------------:");
		x.pl(":      : ..18 : cr invalids          :");
		x.pl(": wait : "+fld("x000",Integer.toHexString(opwait))+" : wait for notify x    :");
...
//		}
	...
	public void to(final xwriter x)throws Throwable{
		if(pt()==null)x.title("znxrci mega 20 bits");
		if(mode==1){
			x.el(this);
//			x.p(coreid);
			rendpanel(x);
