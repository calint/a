...
final public class $ extends a{{upd();}
	public void to(final xwriter x)throws Throwable{
		...
		x.div(this,null,"margin:0;border:1px dashed;border-radius:.5em;box-shadow:0 0 1em rgba(1,0,0,1);padding:5em;padding-top:0;background:#222;color:#0c0;text-align:center;display:table;margin-left:auto;margin-right:auto",null);
