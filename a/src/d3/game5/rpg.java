...
public final class rpg extends bullet{
	...
	public static double expl_scl0=3;
	public static double expl_scl1=2;
	public static double expl_scl2=4;
	public static double expl_t0=1;
	public static double expl_t1=0.1;
	...
	public static double topspd0=88;
	public static double trace_evry=1;
	public static double trace_lftm=0.6;
	public static double trace_size=.7;
	public static double zaxisrot0=Math.PI;
	private double trace_t=trace_evry;
	public rpg(objm shooter,p3 p){
		super(shooter,p,dmg0,topspd0,polh0,scl0,topage0,false,zaxisrot0,0);
		cfg.cnt_rpg++;
	}
	public void death(){
		super.death();
