...
public final class ai{
	...
	public ai(){}
	public ai trgbits(final int trgbits){
		this.trgbits=trgbits;
		return this;
	}
	public ai trg(final objm trg){
		this.trg=trg;
		state=ATTACK;
		return this;
	}
	...
	private String distm(final double a){
			...
			if(aquiretarget_t>aquiretarget_evry){
				...
				for(obj o:ls){
					...
					if(vhl.getClass().equals(o.getClass()))
						continue;
					p3 v=new p3(vhl.pos(),o.pos()).norm();
					double d=v.dotprod(vhl.lookvec());
					if(d<0)
						continue;
