...
abstract public class store_wrap implements store{
	...
	@Override public void foreach(final Class<? extends itm>cls,final itm owner,final String q,final store.visitor v)throws Throwable{wrap.foreach(cls,owner,q,v);}
